...
class Services extends CI_Controller
{
    ...
    $postData = $this->input->post("longitude");
    log_message("debug","This is an Ajax request post: ". $postData );
          $json = json_decode($this->input->raw_input_stream);
          log_message("debug","This is an Ajax request stream : ".$json->latitude );


    //$location = json_decode(trim(file_get_contents('php://input')), true);
    //var_dump($location);
    //print_r($location);
           //log_message("debug","lat: ".$location['longitude']  );
