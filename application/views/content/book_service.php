...
<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOaRGKwVpj8n3v77GoCuHw6I96QVtCwZo&callback=initialize">
</script>
...
<script>
    ...
    function RelatedLocationAjax() {
                      ...
                      /*   formData.latitude = lat.value;
                        formData.longitude = lng.value;
                        formData.ServiceId =  ServiceId.value;
                        console.log(JSON.stringify(formData)); */
                        console.log(formData);
                            $.ajax({
                                url:"<?php echo site_url(); ?>services/closest_locations",
                                method:"POST",
